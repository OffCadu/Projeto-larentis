    ...
    @component('layouts._components.topo_unidade')
        @if ($nome != '' )
            @if ($gerente)
                    <li><a href="/gerencia">Gerência</a></li>
                    <li> Bem vindo, gerente {{$nome}} </li>
             @elseif (isset($atendente))
                    <li><a href="/gerencia">Gerência</a></li>
                    <li> Bem vindo, atendente {{$nome}} </li>
            @else
                    <li>Bem vindo, {{$nome}}</li>
                    {{-- @if (isset($pessoa_fisica))
                        @dd($pessoa_fisica)
                        <li><a href="{{ route('pessoa_fisica.{$pessoa_fisica}.edit', ['pessoa_fisica' => $pessoa_fisica ]) }}"> Bem vindo,{{$nome}} </a></li>
                    @else
                        <li><a href="/pessoa_fisica/create"> Bem vindo,{{$nome}} </a></li>
                    @endif --}}
            @endif
        @else
            <div class="d-inline">
                ...
                <li>|</li>
                <li><a href="/register"><b>Registro</b></a></li>
            </div>
        @endif
    @endcomponent
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a href="quarto1"><img src="../assets/img/larentisII/quarto_1.jpg" alt=""></a>
                                </div>
                                <div class="room-caption">
                                    <h3><a href="quarto1">Suíte Vip Love</a></h3>
                                    <div class="per-night">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a href="quarto2"><img src="../assets/img/larentisII/quarto_2.jpg" alt=""></a>
                                </div>
                                <div class="room-caption">
                                    <h3><a href="quarto2">Classico Solteiro</a></h3>
                                    <div class="per-night">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a href="quarto3"> <img src="../assets/img/larentisII/quarto_3.jpg" alt=""></a>
                                </div>
                                <div class="room-caption">
                                    <h3><a href="quarto3">Suíte Casal</a></h3>
                                    <div class="per-night">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a href="quarto4"><img src="../assets/img/larentisII/quarto_4.jpg" alt=""></a>
                                </div>
                                <div class="room-caption">
                                    <h3><a href="quarto4">Suíte Rústica Casal</a></h3>
                                    <div class="per-night">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a href="quarto5"><img src="../assets/img/larentisII/quarto_5.jpg" alt=""></a>
                                </div>
                                <div class="room-caption">
                                    <h3><a href="quarto5">Suíte Lazer</a></h3>
                                    <div class="per-night">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a href="quarto6"> <img src="../assets/img/larentisII/quarto_6.jpg" alt=""></a>
                                </div>
                                <div class="room-caption">
                                    <h3><a href="quarto6">Suíte Love Casal</a></h3>
                        ...
                        <div class="col-md-12">
                            <div class="gallery-active owl-carousel">
                                <div class="gallery-img">
                                    <a href="quarto1"><img src="../assets/img/larentisII/final_page1.jpg" alt=""></a>
                                </div>
                                <div class="gallery-img">
                                    <a href="quarto2"><img src="../assets/img/larentisII/final_page2.jpg" alt=""></a>
                                </div>
                                <div class="gallery-img">
                                    <a href="quarto3"><img src="../assets/img/larentisII/final_page3.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
