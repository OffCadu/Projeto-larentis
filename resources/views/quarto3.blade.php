            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    ...
                    <div class="font-back-tittle mb-45">
                        ...
                        <h3 class="archivment-back">Suíte Casal</h3>
                    </div>
                </div>
            </div>
<!--inicio sobre-->
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="customer-img mb-120">
                        <img src="../assets/img/larentisII/quarto_3.jpg" class="customar-img1" alt="">
                    ...
                    <div class="customer-caption">
                        <div class="caption-details">
                            ...
                            <p> Tamanho: 10m²<br><br> 
                                ...
                                Descrição: É um ótimo quarto para casais que buscam um local calmo, o quarto conta com uma rede na varanda para um melhor lazer!<br><br> 
                                Especificações: Esta suíte possui ar-condicionado, uma cama de casal, TV a cabo, frigobar e rede.<br><br>
                                Preço: 150R$ a diária.
                            </p>
