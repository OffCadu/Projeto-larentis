            ...
            <div class="col-xl-8">
                ...
                <div class="font-back-tittle mb-45">
                    <div class="archivment-front">
                        <h3>Suíte Vip Love</h3>
                    </div>
                    <h3 class="archivment-back">Suíte Vip Love</h3>
                </div>
            </div>
        </div>
<!--inicio sobre-->
        ...
        <div class="row">
            <div class="col-xl-5 col-lg-6">
                <div class="customer-img mb-120">
                    <img src="../assets/img/larentisII/quarto_1.jpg" class="customar-img1" alt="">
                ...
                <div class="customer-caption">
                    <div class="caption-details">
                        ...
                        <p> Tamanho: 14m²<br><br> 
                            ...
                            Descrição: É um ótimo quarto para casais que buscam um local calmo e quente para intensificar ainda mais seu amor!<br><br> 
                            Especificações: Esta suíte possui vista para a piscina, cama de casal, Tv a cabo e ar-condicionado.<br><br>
                            Preço: 190R$ a diária.
                        </p>
