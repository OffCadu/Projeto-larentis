                ...
                <div class="col-xl-8">
                    ...
                    <div class="font-back-tittle mb-45">
                        <div class="archivment-front">
                            <h3>Suíte Rústica Casal</h3>
                        </div>
                        <h3 class="archivment-back">Suíte Rústica Casal</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="customer-img mb-120">
                        <img src="../assets/img/larentisII/quarto_4.jpg" class="customar-img1" alt="">
                    ...
                    <div class="customer-caption">
                        <div class="caption-details">
                            ...
                            <p> Tamanho: 14m²<br><br> 
                                ...
                                Descrição: É um ótimo quarto para casais que buscam um local calmo e um local rústico e com mesa para refeições!<br><br> 
                                Especificações: Esta suíte possui frigobar, ar-condicionado, cama de casal, TV a cabo e mesa de jantar.<br><br>
                                Preço: 150R$ a diária.
                            </p>
